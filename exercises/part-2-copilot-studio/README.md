...
- สร้าง **Financial Report Assistant** ของ GSB ที่มี instruction, topic วิเคราะห์ไฟล์ Excel ด้วย Prompt node, knowledge และ email tool ก่อนเผยแพร่ตามสิทธิ์ของ tenant
...
3. [Add Agent Flow email tool and test](exercise-3-agent-flow-as-a-tools/README.md) 
4. [Build the Report Intake Topic (Excel + Prompt node)](exercise-4-topic/README.md) 
